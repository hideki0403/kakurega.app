	...
	<header :class="$style.header">
		...
		<div :class="$style.headerRight">
			<template v-if="!(targetChannel != null && fixed)">
				...
				<button ref="submitButtonEl" v-click-anime class="_button" :class="$style.submit" :disabled="!canPost" data-testid="post-form-submit"
					@click="post">
...
async function toggleReactionAcceptance() {
	...
	if (prefer.s.rememberReactionAcceptance) {
		store.set('reactionAcceptance', select.result);
	}
